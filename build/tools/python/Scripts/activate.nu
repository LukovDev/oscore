...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'K:\Kukov\Top PROJECTS\pythonProject\.idea\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'K:\Kukov\Top PROJECTS\pythonProject\.idea\venv\Scripts\deactivate.nu'
